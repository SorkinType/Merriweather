...
<details>
<summary><b>[153] Merriweather[opsz,wdth,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** Name table entry ("Copyright 2020 The Merriweather Project Authors (https://github.com/SorkinType/Merriweather/), with Reserved Font Name "Merriweather".") contains "Reserved Font Name". This is an error except in a few specific rare cases. [code: rfn]
...
* ⚠ **WARN** Instance "Text SemiExpanded Light": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiExpanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiExpanded Regular": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiExpanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiExpanded Bold": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiExpanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiExpanded Black": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiExpanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Head SemiExpanded Light": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiExpanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head SemiExpanded Regular": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiExpanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head SemiExpanded Bold": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiExpanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head SemiExpanded Black": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiExpanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Display SemiExpanded Light": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiExpanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiExpanded Regular": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiExpanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiExpanded Bold": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiExpanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiExpanded Black": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiExpanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Big SemiExpanded Light": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiExpanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big SemiExpanded Regular": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiExpanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big SemiExpanded Bold": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiExpanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big SemiExpanded Black": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiExpanded Black": cannot determine instance name due to unparsable tokens
...
* ℹ **INFO** This font contains the following optional tables [prep, DSIG, GPOS, loca, GSUB, gasp]
...
* 🍞 **PASS** fonts/variable/Merriweather[opsz,wdth,wght].ttf is named canonically.
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2020 The Merriweather Project Authors (https://github.com/SorkinType/Merriweather/), with Reserved Font Name "Merriweather".' matches canonical pattern.
