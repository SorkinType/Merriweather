...
<details>
<summary><b>[153] Merriweather-Roman[opsz,wdth,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'Merriweather-Roman[opsz,wdth,wght].ttf' must be renamed to 'Merriweather[opsz,wdth,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* ⚠ **WARN** Instance "Semi Expanded Light": contains the following unparsable tokens "['Semi']"
* ⚠ **WARN** Instance "Semi Expanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Semi Expanded Regular": contains the following unparsable tokens "['Semi']"
* ⚠ **WARN** Instance "Semi Expanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Semi Expanded Bold": contains the following unparsable tokens "['Semi']"
* ⚠ **WARN** Instance "Semi Expanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Semi Expanded Black": contains the following unparsable tokens "['Semi']"
* ⚠ **WARN** Instance "Semi Expanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Text SemiCondensed Light": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiCondensed Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiCondensed Regular": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiCondensed Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiCondensed Bold": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiCondensed Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiCondensed Black": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiCondensed Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text Semi Expanded Light": contains the following unparsable tokens "['Text', 'Semi']"
* ⚠ **WARN** Instance "Text Semi Expanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text Semi Expanded Regular": contains the following unparsable tokens "['Text', 'Semi']"
* ⚠ **WARN** Instance "Text Semi Expanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text Semi Expanded Bold": contains the following unparsable tokens "['Text', 'Semi']"
* ⚠ **WARN** Instance "Text Semi Expanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text Semi Expanded Black": contains the following unparsable tokens "['Text', 'Semi']"
* ⚠ **WARN** Instance "Text Semi Expanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Head Regular": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head Regular": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Head SemiCondensed Light": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiCondensed Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head SemiCondensed Regular": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiCondensed Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head SemiCondensed Bold": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiCondensed Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head SemiCondensed Black": contains the following unparsable tokens "['Head']"
* ⚠ **WARN** Instance "Head SemiCondensed Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head Semi Expanded Light": contains the following unparsable tokens "['Head', 'Semi']"
* ⚠ **WARN** Instance "Head Semi Expanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head Semi Expanded Regular": contains the following unparsable tokens "['Head', 'Semi']"
* ⚠ **WARN** Instance "Head Semi Expanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head Semi Expanded Bold": contains the following unparsable tokens "['Head', 'Semi']"
* ⚠ **WARN** Instance "Head Semi Expanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Head Semi Expanded Black": contains the following unparsable tokens "['Head', 'Semi']"
* ⚠ **WARN** Instance "Head Semi Expanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Display SemiCondensed Light": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiCondensed Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiCondensed Regular": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiCondensed Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiCondensed Bold": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiCondensed Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiCondensed Black": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiCondensed Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display Semi Expanded Light": contains the following unparsable tokens "['Display', 'Semi']"
* ⚠ **WARN** Instance "Display Semi Expanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display Semi Expanded Regular": contains the following unparsable tokens "['Display', 'Semi']"
* ⚠ **WARN** Instance "Display Semi Expanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display Semi Expanded Bold": contains the following unparsable tokens "['Display', 'Semi']"
* ⚠ **WARN** Instance "Display Semi Expanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display Semi Expanded Black": contains the following unparsable tokens "['Display', 'Semi']"
* ⚠ **WARN** Instance "Display Semi Expanded Black": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Big Regular": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big Regular": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Big SemiCondensed Light": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiCondensed Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big SemiCondensed Regular": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiCondensed Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big SemiCondensed Bold": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiCondensed Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big SemiCondensed Black": contains the following unparsable tokens "['Big']"
* ⚠ **WARN** Instance "Big SemiCondensed Black": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big Semi Expanded Light": contains the following unparsable tokens "['Big', 'Semi']"
* ⚠ **WARN** Instance "Big Semi Expanded Light": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big Semi Expanded Regular": contains the following unparsable tokens "['Big', 'Semi']"
* ⚠ **WARN** Instance "Big Semi Expanded Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big Semi Expanded Bold": contains the following unparsable tokens "['Big', 'Semi']"
* ⚠ **WARN** Instance "Big Semi Expanded Bold": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Big Semi Expanded Black": contains the following unparsable tokens "['Big', 'Semi']"
* ⚠ **WARN** Instance "Big Semi Expanded Black": cannot determine instance name due to unparsable tokens
...
* ℹ **INFO** Hinting filesize impact:
	...
	|  | fonts/variable/Merriweather-Roman[opsz,wdth,wght].ttf |
	|:--- | ---:|
	| Dehinted Size | 1.2Mb |
	| Hinted Size | 1.2Mb |
	| Increase | -1020 bytes |
...
* ℹ **INFO** This font contains the following optional tables [loca, GSUB, prep, DSIG, gasp, GPOS]
